...
export function list(query: any) {
  return request({
    url: '/message/v1/wxAccount/wxAccountList',
    method: 'get',
    params: query
  })
}
...
// 修改角色
export function updateWechat(data: any) {
  return request({
    url: '/message/v1/wxAccount/editWxAccount/' + data.id,
    method: 'put',
    data: data
  })
}
...
export function delRole(roleId: any) {
  return request({
    url: '/message/v1/wxAccount/' + roleId,
    method: 'delete'
  })
}
