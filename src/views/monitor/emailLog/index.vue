  ...
  <div class="app-container">
    ...
    <el-dialog title="操作日志详细" v-model="open" center append-to-body>
      <div class="demo-drawer__content ">
        <el-form class="m20" ref="ruleFormRef" :model="rulesForm" label-width="100px" size="small" label-position="left">
          <el-row>
            <el-col :span="24">
            ...
            <el-col :span="24">
              <el-form-item label="错误信息:" v-if="rulesForm.errorLog">{{ rulesForm.errorLog }}</el-form-item>
            </el-col>
            <el-col :span="24">
