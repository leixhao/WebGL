  ...
  <div class="app-container">
    ...
    <el-dialog title="操作日志详细" v-model="open" center append-to-body>
      <div class="demo-drawer__content">
        <el-form class="m20" ref="form" :model="rulesForm" label-width="100px" size="small" label-position="left">
          <el-row>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="key配置:" v-if="rulesForm.webHookKey">{{ rulesForm.webHookKey }}</el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="配置CODE:" v-if="rulesForm.configNo">{{ rulesForm.configNo }}</el-form-item>

            </el-col>
            <el-col :span="12">
              <el-form-item label="企业微信ID:" v-if="rulesForm.agentId">{{ rulesForm.agentId }}</el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="客户端IP:" v-if="rulesForm.clientIp">{{ rulesForm.clientIp }}</el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="企业微信应用密钥:" label-width="120" v-if="rulesForm.corpSecret">
                <el-tooltip class="item" effect="dark" :content="rulesForm.corpSecret" placement="top">
                  <div style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;word-break: break-all;">
            ...
            <el-col :span="12">
              <el-form-item label="时长:" v-if="rulesForm.sometimes">{{ rulesForm.sometimes }}</el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="24">
              <el-form-item label="发送时间:" v-if="rulesForm.sendTime">{{ rulesForm.sendTime }} </el-form-item>
            </el-col>
            <el-col :span="24">
