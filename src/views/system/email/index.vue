  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
      ...
      <el-form-item label="邮件账号CODE" prop="maNo">
        <el-input v-model="queryParams.maNo" placeholder="邮件账号CODE" clearable size="small" style="width: 240px"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="是否禁用" prop="enable">
        <el-select v-model="queryParams.enable" placeholder="是否禁用" clearable size="small" style="width: 240px">
      ...
      <el-form-item>
        ...
        <el-button icon="el-icon-refresh" size="small" @click="resetQuery">{{ $t('button.reset') }}</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table class="table_divClass" v-loading="loading" :data="emailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed="right" min-width="100" label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button size="small" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)">{{ $t('button.edit')
          }}</el-button>
    ...
    <!-- 添加或修改email -->
    <el-dialog :title="title" :visible.sync="open" center append-to-body>
