  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item :label="$t('operlog.module')" prop="title">
        <el-input v-model="queryParams.title" :placeholder="$t('operlog.moduleIpt')" clearable style="width: 240px;"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item :label="$t('operlog.name')" prop="operName">
        <el-input v-model="queryParams.operName" :placeholder="$t('operlog.nameIpt')" clearable style="width: 240px;"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item :label="$t('operlog.type')" prop="businessType">
        <el-select v-model="queryParams.businessType" :placeholder="$t('operlog.type')" clearable style="width: 240px">
      ...
      <el-form-item :label="$t('operlog.status')" prop="status">
        <el-select v-model="queryParams.status" :placeholder="$t('operlog.status')" clearable style="width: 240px">
      ...
      <el-form ref="form" :model="rulesForm" label-width="100px">
        <el-row>
          ...
          <el-col :span="12" v-if="rulesForm.operTime">
            <el-form-item :label="$t('operlog.time') + ':'">{{ parseTime(rulesForm.operTime) }}</el-form-item>
          </el-col>
