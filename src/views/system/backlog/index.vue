    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="主题" prop="title">
                <el-input v-model="queryParams.title" placeholder="请输入主题" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="模块" prop="moduleName">
                <el-input v-model="queryParams.moduleName" placeholder="请输入模块" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
        ...
        >删除</el-button>
            ...
            <el-col :span="1.5">
                <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                    v-hasPermi="['system:backlog:export']">导出</el-button>
            </el-col>
         ...
         <template slot-scope="scope">
          ...
          >修改</el-button> -->
                    <el-button size="mini" link type="primary" icon="el-icon-delete" @click="handleDelete(scope.row)"
                        v-hasPermi="['system:backlog:remove']">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
